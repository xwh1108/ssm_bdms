...
<body class="hold-transition skin-purple sidebar-mini">
								...
								<div class="form-group form-inline">
									<div class="btn-group">
										<button type="button" class="btn btn-default" title="新建"
											onclick="location.href='${pageContext.request.contextPath}/page/product-add.jsp'">
                ...
                <div class="box-footer">
                    ...
                    <div class="box-tools pull-right">
                        <ul class="pagination">
							...
							<li><a href="${pageContext.request.contextPath}/orders/findAll?page=${pagNum}&pageSize=${pageInfo.pageSize}">${pagNum}</a></li>
							</c:forEach>
	...
	<script>
		...
		function changePageSize() {
			...
			//向服务器发送请求，改变没页显示条数
			location.href = "${pageContext.request.contextPath}/orders/findAll?page=${pageInfo.pageNum}&pageSize="
					+ pageSize;
		}
